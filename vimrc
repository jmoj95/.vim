...
" Most of the commands below and their comments were taken from the vimrc
" example at (http://vim.wikia.com/wiki/Example_vimrc).
" Other sources:
...
" Got the description below by typing :help nocompatible:
...
" Hide files that matche any of the .gitignore descriptions
